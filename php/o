    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="order1.php">Order </a></li>
        </ul>
    ...
    <form name=frm method=post action="order1.php">
        ...
        <table border="1" align="center" cellpadding="3" cellspacing="3">
            ...
            <tr>
                ...
                $cn=mysql_connect("localhost","root");
                mysql_select_db("buildingmaterial",$cn);
                $sql="select materialid ,subtype from material";
                $result=mysql_query($sql,$cn);
                while($row=mysql_fetch_array($result))
                {
            ...
            <tr>
                <!--Quantity-->
                <td>Quantity</td>
                <td><input type="text" name="qty" style="width: 170px" onKeyPress="return valid2(event)"><?php echo $err5; ?></td>
            </tr>
...
if($fl==0)
{
$sql1="select * from material where materialid='$_POST[mid]'";
$result=mysql_query($sql1,$cn);
$row=mysql_fetch_array($result);
$rt=$row[4];
$amt=$rt*$_POST['qty'];
$sql="insert into order1 values('$_POST[ono]','$_POST[odt]','$_POST[cid]','$_POST[mid]','$_POST[qty]','$rt','$amt')";
mysql_query($sql,$cn);

    $sql="update customer set balanceamount=balanceamount-'$amt' where customerid='$_POST[cid]'";
    mysql_query($sql,$cn);
...
if($fl==0)
{
  $sql="update order1 set orderdate='$_POST[odt]',customerid='$_POST[cid]',materialid='$_POST[mid]',quantity='$_POST[qty]' where orderno='$_POST[ono]'";
  mysql_query($sql,$cn);
